...
---
<pre>
<b> Name: Raghav Phophaliya - 20BCE1140</b>
<b>       Sidhant Singh - 20BCE1625</b>
<b>       Akshit Jain - 20BCE1818</b>
<b>       Radhika Solanki - 20BPS1044</b>
<b>
</pre>
<br><br>
...
```{r}
model5 <- lm(PremiumPrice ~ ., data=train)
summary(model5)
predicted <- predict(model5, test)
RMSE <- sqrt(mean((predicted-test$PremiumPrice)^2))
RMSE
```
